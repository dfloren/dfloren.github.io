...
(function () {
    ...
    function fadeOutAndCelebrate() {
        ...
        setTimeout(() => {
            ...
            polaroid.style.width = '215px';
            polaroid.style.height = '375px';
            polaroid.style.backgroundColor = 'white';
            polaroid.style.padding = '0px 20px 30px 20px';
            polaroid.style.borderRadius = '5px';
            polaroid.style.boxShadow = '0 4px 20px rgba(0,0,0,0.8)';
            polaroid.style.display = 'flex';
            polaroid.style.flexDirection = 'column';
            polaroid.style.alignItems = 'center';
            polaroid.style.justifyContent = 'flex-end';
            polaroid.style.zIndex = '10';

            // Linear gradient background
            polaroid.style.backgroundImage = `
...
`;
            ...
            birthdayMessage.style.color = 'black';
            birthdayMessage.style.fontWeight = 'bold';
            birthdayMessage.style.padding = "2px";
            birthdayMessage.style.borderRadius = "3px";
